    ...
    '../../node_modules/axios/lib/utils.js': [
      function (require, module, exports) {
        ...
        function forEach(obj, fn, { allOwnKeys = false } = {}) {
          // Don't bother  no value provided
 ...
 */
      ...
      function (require, module, exports) {
        ...
        _utils.default.forEach(
          ...
          function forEachMethodWithData(method) {
            defaults.headers[method] =
              _utils.default.merge(DEFAULT_CONTENT_TYPE);
          }
        );
        ...
        var _default =
          ...
          function (config) {
            return new Promise(function dispatchXhrRequest(resolve, reject) {
              ...
              if (
                _utils.default.isFormData(requestData) &&
        ...
        var _default = {
          getAdapter: (adapters) => {
            ...
            for (let i = 0; i < length; i++) {
              ...
              if (
                (adapter = _utils.default.isString(nameOrAdapter)
            ...
            if (!adapter) {
              ...
              throw new Error(
                _utils.default.hasOwnProp(knownAdapters, nameOrAdapter)
    ...
    'updateSettings.js': [
      function (require, module, exports) {
        ...
        exports.updatePassword = exports.updateNameEmail = void 0;
        var _axios = _interopRequireDefault(require('axios'));
        ...
        var updateNameEmail = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(form) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
          ...
          return function updateNameEmail(_x) {
            return _ref.apply(this, arguments);
          };
        })();
        exports.updateNameEmail = updateNameEmail;
      ...
      { axios: '../../node_modules/axios/index.js', './login': 'login.js' },
    ],
    'index.js': [
      function (require, module, exports) {
        'use strict';
        ...
        var updatePassForm = document.querySelector('.form-user-settings');
        if (loginForm) {
        ...
        if (updateForm) {
          updateForm.addEventListener('submit', function (e) {
            ...
            (0, _updateSettings.updateNameEmail)(form);
          });
        }
        if (updatePassForm) {
          updatePassForm.addEventListener(
            'submit',
            /*#__PURE__*/ (function () {
              var _ref = _asyncToGenerator(
                /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(e) {
                  var currpass, pass, passconfirm;
      ...
      { './login': 'login.js', './updateSettings': 'updateSettings.js' },
    ],
